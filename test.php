...
$sql = "SELECT * FROM course WHERE year_number LIKE '%$search%'ORDER BY year_number ASC"; 
$conn= mysqli_connect("localhost","root","","its") 
or die("Error: " . mysqli_error($conn));
mysqli_query($conn, "SET NAMES 'utf8' ");
$query=mysqli_query($conn,"SELECT year(year_number) FROM year WHERE term LIKE '%$search%'");
	...
	$nquery=mysqli_query($conn,"SELECT * from  year WHERE year_number LIKE '%$search%' $limit");
